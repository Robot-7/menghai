...
cp -uf ..\..\src\com\youai\dreamonepiece\platform\mi\XiaoMiActivity.java .\src\com\youai\dreamonepiece\platform\mi\XiaoMiActivity.java
cp -uf ..\..\src\com\youai\dreamonepiece\platform\mi\PlatformXiaoMiLoginAndPay.java .\src\com\youai\dreamonepiece\platform\mi\PlatformXiaoMiLoginAndPay.java

for /r ./src %%i in (*.java) do (
	sed -i "s/com.youai.dreamonepiece.platform.*.R;/com.youai.dreamonepiece.platform.mi.R;/g" %%i
)
sed -i "s/import com.youai.dreamonepiece.platform.*;/import com.youai.dreamonepiece.platform.mi.XiaoMiActivity;/g;s/,.*.Activity.class);$/,XiaoMiActivity.class);/g" .\src\com\youai\dreamonepiece\NotificationService.java
echo -----copy res-----

cp -ri ../../res_xiaomi/* .\res\

echo -----copy libs-----

cp -uf ..\..\libs\xiaomi\alipay_msp.jar .\libs\alipay_msp.jar
...
cp -uf ..\..\libs\xiaomi\SDK_TY_2.1.0.jar .\libs\SDK_TY_2.1.0.jar
