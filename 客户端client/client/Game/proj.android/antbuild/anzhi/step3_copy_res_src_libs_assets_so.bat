...
cp -uf ..\..\src\com\youai\dreamonepiece\platform\anzhi\AnZhiActivity.java .\src\com\youai\dreamonepiece\platform\anzhi\AnZhiActivity.java
cp -uf ..\..\src\com\youai\dreamonepiece\platform\anzhi\PlatformAnZhiLoginAndPay.java .\src\com\youai\dreamonepiece\platform\anzhi\PlatformAnZhiLoginAndPay.java

for /r ./src %%i in (*.java) do (
	sed -i "s/com.youai.dreamonepiece.platform.*.R;/com.youai.dreamonepiece.platform.anzhi.R;/g" %%i
)
sed -i "s/import com.youai.dreamonepiece.platform.*;/import com.youai.dreamonepiece.platform.anzhi.AnZhiActivity;/g;s/,.*.Activity.class);$/,AnZhiActivity.class);/g" .\src\com\youai\dreamonepiece\NotificationService.java
...
cp -uf ..\..\libs\anzhi\AnzhiSDKUCenter1.0.0.jar .\libs\AnzhiSDKUCenter1.0.0.jar
