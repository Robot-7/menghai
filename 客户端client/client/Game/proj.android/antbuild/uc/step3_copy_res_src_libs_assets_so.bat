...
cp -uf ..\..\src\com\youai\Util.java .\src\com\youai\Util.java
...
cp -uf ..\..\src\com\youai\dreamonepiece\platform\uc\UcActivity.java .\src\com\youai\dreamonepiece\platform\uc\UcActivity.java
cp -uf ..\..\src\com\youai\dreamonepiece\platform\uc\PlatformUCLoginAndPay.java .\src\com\youai\dreamonepiece\platform\uc\PlatformUCLoginAndPay.java

for /r ./src %%i in (*.java) do (
	sed -i "s/com.youai.dreamonepiece.platform.*.R;/com.youai.dreamonepiece.platform.uc.R;/g" %%i
)
sed -i "s/import com.youai.dreamonepiece.platform.*;/import com.youai.dreamonepiece.platform.uc.UcActivity;/g;s/,.*.Activity.class);$/,UcActivity.class);/g" .\src\com\youai\dreamonepiece\NotificationService.java
echo -----copy res-----
...
cp -uf ..\..\libs\uc\alipay_msp.jar .\libs\alipay_msp.jar
cp -uf ..\..\libs\uc\jackson-all-1.9.1.jar .\libs\jackson-all-1.9.1.jar
cp -uf ..\..\libs\uc\UCGameSDK.jar .\libs\UCGameSDK.jar
