...
cp -uf ..\..\src\com\youai\dreamonepiece\platform\DK\DuokuActivity.java .\src\com\youai\dreamonepiece\platform\DK\DuokuActivity.java
cp -uf ..\..\src\com\youai\dreamonepiece\platform\DK\PlatformDuokuLoginAndPay.java .\src\com\youai\dreamonepiece\platform\DK\PlatformDuokuLoginAndPay.java

for /r ./src %%i in (*.java) do (
	sed -i "s/com.youai.dreamonepiece.platform.*.R;/com.youai.dreamonepiece.platform.DK.R;/g" %%i
)
sed -i "s/import com.youai.dreamonepiece.platform.*;/import com.youai.dreamonepiece.platform.DK.DuokuActivity;/g;s/,.*.Activity.class);$/,DuokuActivity.class);/g" .\src\com\youai\dreamonepiece\NotificationService.java
...
cp -uf ..\..\libs\duoku\alipay_msp.jar .\libs\alipay_msp.jar
...
cp -uf ..\..\libs\duoku\android_api.jar .\libs\android_api.jar
cp -uf ..\..\libs\duoku\DkPlatformSdk.jar .\libs\DkPlatformSdk.jar
...
set /p str_dk=<..\assetsDuokuDiffDir.txt
cp -urf %str_dk% .\assets\