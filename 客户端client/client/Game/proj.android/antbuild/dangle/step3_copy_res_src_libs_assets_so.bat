...
cp -uf ..\..\src\com\youai\dreamonepiece\platform\dangle\DangLeActivity.java .\src\com\youai\dreamonepiece\platform\dangle\DangLeActivity.java
cp -uf ..\..\src\com\youai\dreamonepiece\platform\dangle\PlatformDangleLoginAndPay.java .\src\com\youai\dreamonepiece\platform\dangle\PlatformDangleLoginAndPay.java

for /r ./src %%i in (*.java) do (
	sed -i "s/com.youai.dreamonepiece.platform.*.R;/com.youai.dreamonepiece.platform.dangle.R;/g" %%i
)
sed -i "s/import com.youai.dreamonepiece.platform.*;/import com.youai.dreamonepiece.platform.dangle.DangLeActivity;/g;s/,.*.Activity.class);$/,DangLeActivity.class);/g" .\src\com\youai\dreamonepiece\NotificationService.java

echo -----copy res-----

cp -ri ../../res_dangle/* .\res\

echo -----copy libs-----

cp -uf ..\..\libs\dangle\alipay_msp.jar .\libs\alipay_msp.jar
...
cp -uf ..\..\libs\dangle\downjoy_sdk_2.0.jar .\libs\downjoy_sdk_2.0.jar
