...
import com.youai.dreamonepiece.platform.dangle.DangLeActivity;
...
public class NotificationService extends Service {
	...
	class NotificationTask extends TimerTask{
		...
		@Override
		public void run() {
				Notification notifica = new Notification(getApplicationInfo().icon, Notititle, showTime);             
				notifica.flags = Notification.FLAG_AUTO_CANCEL;
				Intent intent = new Intent(NotificationService.this,DangLeActivity.class);
				intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP|Intent.FLAG_ACTIVITY_NEW_TASK);      
				//intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
				PendingIntent
				/*PendingIntent contentIntent = PendingIntent.getActivity(
						MainActivity.this, R.string.app_name, intent, PendingIntent.FLAG_UPDATE_CURRENT);*/
				contentIntent = PendingIntent.getActivity(NotificationService.this, 0, intent, PendingIntent.FLAG_ONE_SHOT);   
				
				
				notifica.setLatestEventInfo(NotificationService.this,Notititle, Noticontent, contentIntent);
