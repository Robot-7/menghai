...
cp -uf ..\..\src\com\youai\dreamonepiece\platform\sougou\SouGouActivity.java .\src\com\youai\dreamonepiece\platform\sougou\SouGouActivity.java
cp -uf ..\..\src\com\youai\dreamonepiece\platform\sougou\PlatformSouGouLoginAndPay.java .\src\com\youai\dreamonepiece\platform\sougou\PlatformSouGouLoginAndPay.java

for /r ./src %%i in (*.java) do (
	sed -i "s/com.youai.dreamonepiece.platform.*.R;/com.youai.dreamonepiece.platform.sougou.R;/g" %%i
)
sed -i "s/import com.youai.dreamonepiece.platform.*;/import com.youai.dreamonepiece.platform.sougou.SouGouActivity;/g;s/,.*.Activity.class);$/,SouGouActivity.class);/g" .\src\com\youai\dreamonepiece\NotificationService.java


echo -----copy res-----

cp -ri ../../res_sougou/* .\res\

echo -----copy libs-----

cp -uf ..\..\libs\android-parcel.jar .\libs\android-parcel.jar
cp -uf ..\..\libs\annotations.jar .\libs\annotations.jar
cp -uf ..\..\libs\sogou\FlashRuntimeExtensions.jar .\libs\FlashRuntimeExtensions.jar
cp -uf ..\..\libs\sogou\sogou_game_sdk10.9.jar .\libs\sogou_game_sdk10.9.jar
