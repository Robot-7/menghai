...
cp -uf ..\..\src\com\youai\dreamonepiece\platform\ld\LvDouGameActivity.java .\src\com\youai\dreamonepiece\platform\ld\LvDouGameActivity.java
cp -uf ..\..\src\com\youai\dreamonepiece\platform\ld\PlatformLvDouGameLoginAndPay.java .\src\com\youai\dreamonepiece\platform\ld\PlatformLvDouGameLoginAndPay.java

for /r ./src %%i in (*.java) do (
	sed -i "s/com.youai.dreamonepiece.platform.*.R;/com.youai.dreamonepiece.platform.ld.R;/g" %%i
)

sed -i "s/import com.youai.dreamonepiece.platform.*;/import com.youai.dreamonepiece.platform.ld.LvDouGameActivity;/g;s/,.*.Activity.class);$/,LvDouGameActivity.class);/g" .\src\com\youai\dreamonepiece\NotificationService.java
...
cp -uf ..\..\libs\lvdou\alipay_msp.jar .\libs\alipay_msp.jar
cp -uf ..\..\libs\lvdou\LDGameSDK1.0.2.jar .\libs\LDGameSDK1.0.2.jar
