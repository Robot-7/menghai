...
cp -uf ..\..\src\com\youai\dreamonepiece\platform\wandoujia\WanDouJiaActivity.java .\src\com\youai\dreamonepiece\platform\wandoujia\WanDouJiaActivity.java
cp -uf ..\..\src\com\youai\dreamonepiece\platform\wandoujia\PlatformWanDouJiaLoginAndPay.java .\src\com\youai\dreamonepiece\platform\wandoujia\PlatformWanDouJiaLoginAndPay.java

for /r ./src %%i in (*.java) do (
	sed -i "s/com.youai.dreamonepiece.platform.*.R;/com.youai.dreamonepiece.platform.wandoujia.R;/g" %%i
)
sed -i "s/import com.youai.dreamonepiece.platform.*;/import com.youai.dreamonepiece.platform.wandoujia.WanDouJiaActivity;/g;s/,.*.Activity.class);$/,WanDouJiaActivity.class);/g" .\src\com\youai\dreamonepiece\NotificationService.java
echo -----copy res-----

cp -ri ../../res_wandoujia/* .\res\

echo -----copy libs-----

cp -uf ..\..\libs\wandoujia\alipay_msp.jar .\libs\alipay_msp.jar
...
cp -uf ..\..\libs\wandoujia\paysdk.jar .\libs\paysdk.jar

echo -----copy so-----

cp -uf ..\..\libs\armeabi\libDreamOnePiece.so .\libs\armeabi\libDreamOnePiece.so
cp -uf ..\..\libs\armeabi\libudid.so .\libs\armeabi\libudid.so
cp -uf ..\..\libs\armeabi-v7a\libDreamOnePiece.so .\libs\armeabi-v7a\libDreamOnePiece.so
cp -uf ..\..\libs\armeabi-v7a\libudid.so .\libs\armeabi-v7a\libudid.so
