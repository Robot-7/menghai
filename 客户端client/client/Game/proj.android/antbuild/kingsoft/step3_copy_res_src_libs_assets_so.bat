...
cp -uf ..\..\src\com\youai\dreamonepiece\platform\kingsoft\JinShanActivity.java .\src\com\youai\dreamonepiece\platform\kingsoft\JinShanActivity.java
cp -uf ..\..\src\com\youai\dreamonepiece\platform\kingsoft\PlatformJinShanLoginAndPay.java .\src\com\youai\dreamonepiece\platform\kingsoft\PlatformJinShanLoginAndPay.java

for /r ./src %%i in (*.java) do (
	sed -i "s/com.youai.dreamonepiece.platform.*.R;/com.youai.dreamonepiece.platform.kingsoft.R;/g" %%i
)

sed -i "s/import com.youai.dreamonepiece.platform.*;/import com.youai.dreamonepiece.platform.kingsoft.JinShanActivity;/g;s/,.*.Activity.class);$/,JinShanActivity.class);/g" .\src\com\youai\dreamonepiece\NotificationService.java


echo -----copy res-----

cp -ri ../../res_kingsoft/* .\res\

echo -----copy libs-----

cp -uf ..\..\libs\kingsoft\ksmgsdk_1.6.4.jar .\libs\ksmgsdk_1.6.4.jar
