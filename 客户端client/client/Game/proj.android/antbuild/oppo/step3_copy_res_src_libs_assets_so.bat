...
cp -uf ..\..\src\com\youai\dreamonepiece\platform\oppo\nearme\gamecenter\OppoActivity.java .\src\com\youai\dreamonepiece\platform\oppo\nearme\gamecenter\OppoActivity.java
cp -uf ..\..\src\com\youai\dreamonepiece\platform\oppo\nearme\gamecenter\PlatformOppoLoginAndPay.java .\src\com\youai\dreamonepiece\platform\oppo\nearme\gamecenter\PlatformOppoLoginAndPay.java

for /r ./src %%i in (*.java) do (
	sed -i "s/com.youai.dreamonepiece.platform.*.R;/com.youai.dreamonepiece.platform.oppo.nearme.gamecenter.R;/g" %%i
)
sed -i "s/import com.youai.dreamonepiece.platform.*;/import com.youai.dreamonepiece.platform.oppo.nearme.gamecenter.OppoActivity;/g;s/,.*.Activity.class);$/,OppoActivity.class);/g" .\src\com\youai\dreamonepiece\NotificationService.java
echo -----copy res-----

cp -ri ../../res_default/* .\res\
