...
cp -uf ..\..\src\com\youai\dreamonepiece\platform\nd91\Nd91Activity.java .\src\com\youai\dreamonepiece\platform\nd91\Nd91Activity.java
cp -uf ..\..\src\com\youai\dreamonepiece\platform\nd91\Platform91LoginAndPay.java .\src\com\youai\dreamonepiece\platform\nd91\Platform91LoginAndPay.java

for /r ./src %%i in (*.java) do (
	sed -i "s/com.youai.dreamonepiece.platform.*.R;/com.youai.dreamonepiece.platform.nd91.R;/g" %%i
)
sed -i "s/import com.youai.dreamonepiece.platform.*;/import com.youai.dreamonepiece.platform.nd91.Nd91Activity;/g;s/,.*.Activity.class);$/,Nd91Activity.class);/g" .\src\com\youai\dreamonepiece\NotificationService.java
...
cp -uf ..\..\libs\nd91\alipay_msp.jar .\libs\alipay_msp.jar
...
cp -uf ..\..\libs\nd91\NdComPlatform.jar .\libs\NdComPlatform.jar
cp -uf ..\..\libs\nd91\Game_Analytics_SDK_Android.jar .\libs\Game_Analytics_SDK_Android.jar
