...
cp -uf ..\..\src\com\youai\dreamonepiece\platform\kugou\KuGouActivity.java .\src\com\youai\dreamonepiece\platform\kugou\KuGouActivity.java
cp -uf ..\..\src\com\youai\dreamonepiece\platform\kugou\PlatformKuGouLoginAndPay.java .\src\com\youai\dreamonepiece\platform\kugou\PlatformKuGouLoginAndPay.java

for /r ./src %%i in (*.java) do (
	sed -i "s/com.youai.dreamonepiece.platform.*.R;/com.youai.dreamonepiece.platform.kugou.R;/g" %%i
)
sed -i "s/import com.youai.dreamonepiece.platform.*;/import com.youai.dreamonepiece.platform.kugou.KuGouActivity;/g;s/,.*.Activity.class);$/,KuGouActivity.class);/g" .\src\com\youai\dreamonepiece\NotificationService.java
...
cp -uf ..\..\libs\kugou\alipay_msp.jar .\libs\alipay_msp.jar
cp -uf ..\..\libs\kugou\Kugou_Pay_SDK_Release.jar .\libs\Kugou_Pay_SDK_Release.jar
