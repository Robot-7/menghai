...
cp -uf ..\..\src\com\youai\dreamonepiece\platform\GTV\GTVActivity.java .\src\com\youai\dreamonepiece\platform\GTV\GTVActivity.java
cp -uf ..\..\src\com\youai\dreamonepiece\platform\GTV\PlatformGTVLoginAndPay.java .\src\com\youai\dreamonepiece\platform\GTV\PlatformGTVLoginAndPay.java

for /r ./src %%i in (*.java) do (
	sed -i "s/com.youai.dreamonepiece.platform.*.R;/com.youai.dreamonepiece.platform.GTV.R;/g" %%i
)
sed -i "s/import com.youai.dreamonepiece.platform.*;/import com.youai.dreamonepiece.platform.GTV.GTVActivity;/g;s/,.*.Activity.class);$/,GTVActivity.class);/g" .\src\com\youai\dreamonepiece\NotificationService.java
