...
cp -uf ..\..\src\com\youai\dreamonepiece\platform\yingyonghui\YingYongHuiActivity.java .\src\com\youai\dreamonepiece\platform\yingyonghui\YingYongHuiActivity.java
cp -uf ..\..\src\com\youai\dreamonepiece\platform\yingyonghui\PlatformYingYongHuiLoginAndPay.java .\src\com\youai\dreamonepiece\platform\yingyonghui\PlatformYingYongHuiLoginAndPay.java

for /r ./src %%i in (*.java) do (
	sed -i "s/com.youai.dreamonepiece.platform.*.R;/com.youai.dreamonepiece.platform.yingyonghui.R;/g" %%i
)
sed -i "s/import com.youai.dreamonepiece.platform.*;/import com.youai.dreamonepiece.platform.yingyonghui.YingYongHuiActivity;/g;s/,.*.Activity.class);$/,YingYongHuiActivity.class);/g" .\src\com\youai\dreamonepiece\NotificationService.java

echo -----copy res-----

cp -ri ../../res_yingyonghui/* .\res\

echo -----copy libs-----

cp -uf ..\..\libs\yingyonghui\com.appchina.usersdk.jar .\libs\com.appchina.usersdk.jar
cp -uf ..\..\libs\yingyonghui\pay_proxy_3.3.0.jar .\libs\pay_proxy_3.3.0.jar
