...
cp -uf ..\..\src\com\youai\dreamonepiece\platform\xunlei\HttpReqUtil.java .\src\com\youai\dreamonepiece\platform\xunlei\HttpReqUtil.java
cp -uf ..\..\src\com\youai\dreamonepiece\platform\xunlei\HttpResponse.java .\src\com\youai\dreamonepiece\platform\xunlei\HttpResponse.java
cp -uf ..\..\src\com\youai\dreamonepiece\platform\xunlei\XunLeiActivity.java .\src\com\youai\dreamonepiece\platform\xunlei\XunLeiActivity.java
cp -uf ..\..\src\com\youai\dreamonepiece\platform\xunlei\PlatformXunLeiLoginAndPay.java .\src\com\youai\dreamonepiece\platform\xunlei\PlatformXunLeiLoginAndPay.java

for /r ./src %%i in (*.java) do (
	sed -i "s/com.youai.dreamonepiece.platform.*.R;/com.youai.dreamonepiece.platform.xunlei.R;/g" %%i
)
sed -i "s/import com.youai.dreamonepiece.platform.*;/import com.youai.dreamonepiece.platform.xunlei.XunLeiActivity;/g;s/,.*.Activity.class);$/,XunLeiActivity.class);/g" .\src\com\youai\dreamonepiece\NotificationService.java


echo -----copy res-----

cp -ri ../../res_xunlei/* .\res\
