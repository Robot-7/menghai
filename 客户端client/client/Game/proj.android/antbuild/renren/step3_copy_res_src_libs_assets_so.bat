...
cp -uf ..\..\src\com\youai\dreamonepiece\platform\renren\RenRenActivity.java .\src\com\youai\dreamonepiece\platform\renren\RenRenActivity.java
cp -uf ..\..\src\com\youai\dreamonepiece\platform\renren\PlatformRenRenLoginAndPay.java .\src\com\youai\dreamonepiece\platform\renren\PlatformRenRenLoginAndPay.java

for /r ./src %%i in (*.java) do (
	sed -i "s/com.youai.dreamonepiece.platform.*.R;/com.youai.dreamonepiece.platform.renren.R;/g" %%i
)

sed -i "s/import com.youai.dreamonepiece.platform.*;/import com.youai.dreamonepiece.platform.renren.RenRenActivity;/g;s/,.*.Activity.class);$/,RenRenActivity.class);/g" .\src\com\youai\dreamonepiece\NotificationService.java


echo -----copy res-----

cp -ri ../../res_renren/* .\res\

echo -----copy libs-----

cp -uf ..\..\libs\renren\RennSDK-Android.jar .\libs\RennSDK-Android.jar
cp -uf ..\..\libs\renren\RennSDK-Pay-Android.jar .\libs\RennSDK-Pay-Android.jar
