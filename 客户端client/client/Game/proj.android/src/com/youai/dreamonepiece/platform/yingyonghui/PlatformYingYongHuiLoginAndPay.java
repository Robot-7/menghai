package com.youai.dreamonepiece.platform.yingyonghui;
...
public class PlatformYingYongHuiLoginAndPay implements IPlatformLoginAndPay {
	...
	public void callLogin() {
		...
		AccountManager.openYYHLoginActivity(this.game_ctx, ActivityInfo.SCREEN_ORIENTATION_PORTRAIT, new CallBackListener() {
...
//				String nickName = account.nickName;
			...
			public void onError(Activity activity, ErrorMsg errorMsg) {
				// TODO Auto-generated method stub
				String errorMessage=errorMsg.message;
	...
	public int callPayRecharge(PayInfo pay_info) {
		...
		extInfo = pay_info.description + "-" + pay_info.product_id+"-"+this.login_info.account_uid_str;//区号-物品id，我们自己的订单号不是必须 (15-6.haizeiwang.youai)
		
		PayRequest payRequest = new PayRequest();
		payRequest.addParam("notifyurl", "http://203.195.147.63/recharge_android/newrecharge.php");  //交易结果同步回调地址。
	...
	public void callAccountManage() {
		// TODO Auto-generated method stub
		AccountManager.openYYHAccountCenter(this.game_ctx, ActivityInfo.SCREEN_ORIENTATION_PORTRAIT, true);
	}
