...
public interface Constants {
    ...
    /**
     * 应用服务器为360服务器提供的支付结果通知接口，由360服务器把支付结果通知到这个URI。URI�?��255字符。具体协议请查看文档中，
     * 支付结果通知接口�?     */
    public static final String DEMO_APP_SERVER_NOTIFY_URI = "http://203.195.147.56/newrecharge.php";
