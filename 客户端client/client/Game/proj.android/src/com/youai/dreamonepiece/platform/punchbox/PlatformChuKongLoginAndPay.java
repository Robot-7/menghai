...
public class PlatformChuKongLoginAndPay implements IPlatformLoginAndPay {
	...
	public void callLogin() {
		...
		try {
			...
			String channel=String.valueOf(appInfo.metaData.getInt("chukong_channel",900037));
			JoyInterface.initialize(this.game_ctx, this.joyGL, this.game_info.app_id_str, channel,(JoyCallback) new LoginCallback());
