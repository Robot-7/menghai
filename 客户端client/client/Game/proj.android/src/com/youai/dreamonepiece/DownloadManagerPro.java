...
public class DownloadManagerPro {
    ...
    public String getFileName(long downloadId) {
    	...
    	if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB){
        	...
        	return Environment.getExternalStorageDirectory().getAbsolutePath()+File.separator+Environment.DIRECTORY_DOWNLOADS+File.separator+DownloadApk.DOWNLOAD_FILE_NAME;
        }
