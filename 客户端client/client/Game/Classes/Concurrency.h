 ...
 /************************************************************************/
/*  @author tapir/zhangmingxu
    @version 0.1
        @date July 6th 2012
        @example
        
        cymrd::ThreadService myService;
        myService.execute(new TestServiceTask());
*/
/************************************************************************/

#ifndef __CYMRD_CONCURRENCY_H__
#define __CYMRD_CONCURRENCY_H__
