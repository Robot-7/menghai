...
{
public:
	DiscipleContent(unsigned int id):ContentBase(id){};
	virtual ~DiscipleContent(){};
...
protected:
	...
	{
		static std::string ccbiFileName = "MembersContent.ccbi";
		return ccbiFileName;
	}
};

#ifdef Macro_TestUseCCReViScrollViewFacade
class SoulContentItemData 
	: public cocos2d::extension::CCReViSvItemData
{
public:
	unsigned int		m_iSoulID;
};
#endif
...
{
public:
	SoulContent(unsigned int id):ContentBase(id){};
	virtual ~SoulContent(){};
...
protected:
	virtual const std::string& getCcbiFileName(void) const
	{
		static std::string ccbiFileName = "SoulContent.ccbi";
		return ccbiFileName;
	}
