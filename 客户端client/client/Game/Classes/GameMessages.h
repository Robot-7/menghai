...
struct MsgContinueLoginFlipCard : public GameMessage
{
	RETURN_TRUE_TYPE(MsgContinueLoginFlipCard)
	MsgContinueLoginFlipCard(){};
	unsigned int index;
	//virtual std::string getParameters() const{return StringConverter::toString(index);}
	virtual const unsigned int getTypeId() const{return MSG_CONTINUE_LOGIN_FLIPCARD;}
	virtual GameMessage * clone() const{MsgContinueLoginFlipCard*ret = new MsgContinueLoginFlipCard;ret->index=index;return ret;}
};
...
struct MsgMainFrameRefreshPage : public GameMessage
{
	...
	virtual GameMessage * clone() const{MsgMainFrameRefreshPage*ret = new MsgMainFrameRefreshPage;ret->pageName = pageName;return ret;}
};
...
struct MsgAdventureTeachExpDataInit : public GameMessage
{
	RETURN_TRUE_TYPE(MsgAdventureTeachExpDataInit)
	MsgAdventureTeachExpDataInit(){};
	unsigned int index;
	//virtual std::string getParameters() const{return StringConverter::toString(index);}
	virtual const unsigned int getTypeId() const{return MSG_ADVENTURE_TEACHEXPINIT;}
	virtual GameMessage * clone() const{MsgAdventureTeachExpDataInit*ret = new MsgAdventureTeachExpDataInit;ret->index = index;return ret;}
};

struct MsgPackPreviewSourceMsg : public GameMessage
{
	RETURN_TRUE_TYPE(MsgPackPreviewSourceMsg)
	MsgPackPreviewSourceMsg(){};
	unsigned int index;
	//virtual std::string getParameters() const{return StringConverter::toString(index);}
	virtual const unsigned int getTypeId() const{return MSG_PACKPREVIEW_SOURCE_MSG;}
	virtual GameMessage * clone() const{MsgPackPreviewSourceMsg*ret = new MsgPackPreviewSourceMsg;ret->index = index;return ret;}
};
