...
class SkillConsumeContentItemData 
...
class SkillUpChoosePage;

class SkillConsumeContent
	: public ContentBase
#ifdef Macro_TestUseCCReViScrollViewFacade
	, public cocos2d::extension::CCReViSvItemNodeFacade
#endif
{
	friend class SkillUpChoosePage;
public:
	SkillConsumeContent(unsigned int id, SkillUpChoosePage* ownner)
		: ContentBase(id)
		, mOwnner(ownner)
	{};
	virtual ~SkillConsumeContent(){};
...
private:
	...
	SkillUpChoosePage* mOwnner;

#ifdef Macro_TestUseCCReViScrollViewFacade
	SkillConsumeContentItemData* m_pItemData;
#endif
...
{
public:
	SkillUpChoosePage(void);
	~SkillUpChoosePage(void);

	virtual PAGE_TYPE getPageType() {return PT_CONTENT;}

	CREATE_FUNC(SkillUpChoosePage);
	...
	void setSellectedContent(SkillConsumeContent* member);
...
private:
	...
	std::set<SkillConsumeContent*> mSelectedContents;
