...
public:
  ...
  void AddGlobalState(State<entity_type>* s) { if(s){m_pGlobalStateList.push_back(s);s->Enter(m_pOwner);}}
  void removeGlobalState(State<entity_type>* s) {if(s){m_pGlobalStateList.remove(s);s->Exit(m_pOwner);}}
