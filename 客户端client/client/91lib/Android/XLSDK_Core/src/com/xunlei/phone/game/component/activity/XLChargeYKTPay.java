...
public class XLChargeYKTPay extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.xl_activity_charge_ykt_pay);

        String[] YD_PRICE = { "10" + getString(R.string.xl_yuan), "20" + getString(R.string.xl_yuan), "30" + getString(R.string.xl_yuan), "50" + getString(R.string.xl_yuan), "100" + getString(R.string.xl_yuan), "200" + getString(R.string.xl_yuan), "300" + getString(R.string.xl_yuan), "500" + getString(R.string.xl_yuan) };
        String[] LT_PRICE = { "20" + getString(R.string.xl_yuan), "30" + getString(R.string.xl_yuan), "50" + getString(R.string.xl_yuan), "100" + getString(R.string.xl_yuan), "200" + getString(R.string.xl_yuan), "300" + getString(R.string.xl_yuan), "500" + getString(R.string.xl_yuan) };
        String[] DX_PRICE = { "20" + getString(R.string.xl_yuan), "30" + getString(R.string.xl_yuan), "50" + getString(R.string.xl_yuan), "100" + getString(R.string.xl_yuan) };
        ...
        TextView mChannel = (TextView) findViewById(R.id.xl_charge_ykt_type_text);
        if (mYKTType.equals("1")) {
            mChannel.setText(getString(R.string.xl_yd));
            mData = YD_PRICE;
        } else if (mYKTType.equals("2")) {
            mChannel.setText(getString(R.string.xl_lt));
            mData = LT_PRICE;
        } else {
            mChannel.setText(getString(R.string.xl_dx));
            mData = DX_PRICE;
        }

        mPriceText = (TextView) findViewById(R.id.xl_charge_price_txt);
        final Button selector = (Button) findViewById(R.id.xl_charge_select_num_btn);
        ...
        findViewById(R.id.xl_charge_select_num_panel).setOnClickListener(new OnClickListener() {
        ...
        mPriceDisplayed = (TextView) findViewById(R.id.xl_charge_num_text);
        mPriceDisplayed.setText(mData[0] + "");
        mPriceText.setText(mData[0] + "");

        TextView description = (TextView) findViewById(R.id.xl_charge_description);
        description.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (mDescriptionTable == null) {
                    ...
                    View view = li.inflate(R.layout.xl_pop_description, null);
        ...
        Button confirm = (Button) findViewById(R.id.xl_charge_pay_button);
        confirm.setOnClickListener(new OnClickListener() {

            @Override
            public void onClick(View v) {
                EditText accountEdt = (EditText) findViewById(R.id.xl_charge_ykt_account_edt);
                String account = accountEdt.getText().toString();
                if (account == null || account.equals("")) {
                    Toast.makeText(XLChargeYKTPay.this, getString(R.string.xl_input_account), Toast.LENGTH_SHORT).show();
                    return;
                }

                EditText pasEdt = (EditText) findViewById(R.id.xl_charge_ykt_pas_edt);
                String pas = pasEdt.getText().toString();
                if (pas == null || pas.equals("")) {
                    Toast.makeText(XLChargeYKTPay.this, getString(R.string.xl_input_pas), Toast.LENGTH_SHORT).show();
                    return;
                }

                if (mYKTType.equals("1")) {
                    if (account.length() != 17) {
                        Toast.makeText(XLChargeYKTPay.this, getString(R.string.xl_error_account), Toast.LENGTH_SHORT).show();
                        return;
                    }
                    
                    if (pas.length() != 18) {
                        Toast.makeText(XLChargeYKTPay.this, getString(R.string.xl_error_pas), Toast.LENGTH_SHORT).show();
                        return;
                    }
                } else if (mYKTType.equals("2")) {
                ...
                mChargeDialog.setMessage(XLChargeYKTPay.this.getResources().getString(R.string.xl_charge_checkVersion));
                mChargeDialog.show();
                ...
                Handler handler = new Handler() {
                    ...
                    public void handleMessage(Message msg) {
                        if (msg.what == Result.SUCCESS) {
                            ...
                            Toast.makeText(XLChargeYKTPay.this, getString(R.string.xl_error_getting_order), Toast.LENGTH_LONG).show();
                        }
        ...
        findViewById(R.id.xl_charge_ykt_layout).setFocusableInTouchMode(true);
        findViewById(R.id.xl_charge_ykt_layout).requestFocus();
    }
    ...
    private void bindPriceTable() {
        if (mPriceTable == null) {
            ...
            LayoutInflater li = LayoutInflater.from(XLChargeYKTPay.this);
            View view = li.inflate(R.layout.xl_pop_price_selector, null);
            mPriceTable.requestWindowFeature(Window.FEATURE_NO_TITLE);
            mPriceTable.setContentView(view);

            ListView priceList = (ListView) view.findViewById(R.id.xl_charge_price_selector);
            priceList.setAdapter(new ArrayAdapter<String>(this, R.layout.xl_pop_price_item, mData));
