...
public class ChannelView extends FrameLayout {
    ...
    private void init(String channel) {
        ...
        View view = li.inflate(R.layout.xl_view_charge_channel, this);

        TextView icon = (TextView) view.findViewById(R.id.xl_charge_channel_icon);
        TextView text = (TextView) view.findViewById(R.id.xl_charge_channel_text);

        if (channel.equals(XLApplicationContext.CHANNEL_BANK)) {
            icon.setBackgroundResource(R.drawable.xl_charge_bank);
            text.setText(getContext().getString(R.string.xl_bank));
            ...
            setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ((Activity) getContext()).overridePendingTransition(R.anim.xl_push_right_in, R.anim.xl_push_left_out);
            ...
            icon.setBackgroundResource(R.drawable.xl_charge_cft);
            text.setText(getContext().getString(R.string.xl_cft));
            ...
            icon.setBackgroundResource(R.drawable.xl_charge_ykt);
            text.setText(getContext().getString(R.string.xl_ykt));
            ...
            icon.setBackgroundResource(R.drawable.xl_charge_zfb);
            text.setText(getContext().getString(R.string.xl_zft));
            ...
            icon.setBackgroundResource(R.drawable.xl_charge_credit_card);
            text.setText(getContext().getString(R.string.xl_credit));
