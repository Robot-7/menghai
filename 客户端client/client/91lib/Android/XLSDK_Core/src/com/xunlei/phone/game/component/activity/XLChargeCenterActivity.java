...
public class XLChargeCenterActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.xl_activity_charge_center);
        ...
        if (xlApplicationContext.getXLContextData(XLContext.CHARGE_NUM) == null) {
            findViewById(R.id.xl_charge_num).setVisibility(View.GONE);
            findViewById(R.id.xl_charge_num_split).setVisibility(View.GONE);
        } else {
            TextView chargeNum = (TextView) findViewById(R.id.xl_charge_num_text);
            chargeNum.setText(xlApplicationContext.getXLContextData(XLContext.CHARGE_NUM).toString() + "元");
        }
        ...
        TextView usernameText = (TextView) findViewById(R.id.xl_charge_username_text);
        ...
        TextView gamenameText = (TextView) findViewById(R.id.xl_charge_game_text);
        ...
        mChannelPanel = (TableLayout) findViewById(R.id.xl_charge_channel_panel);
        // channelPanel
