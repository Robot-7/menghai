        ...
        mCurrent.setOnSlideListener(new XLDialog.LoginDialogSlideListener() {
            ...
            public void onSlide() {
                ...
                if (mCurrentPage == 1) {
                    ...
                    mCurrentPage--;
                    Animation rInAnim = AnimationUtils.loadAnimation(mCurrent.getContext(), R.anim.xl_push_left_in);
                    Animation rOutAnim = AnimationUtils.loadAnimation(mCurrent.getContext(), R.anim.xl_push_right_out);
