...
public class XLChargeCFT extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.xl_activity_charge_cft);
        ...
        mWebView = (WebView) findViewById(R.id.xl_charge_cft_wv);
        ...
        mLoading.setMessage(getString(R.string.xl_loading_web));
        mLoading.show();
