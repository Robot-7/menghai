...
public class MobileSecurePayHelper {
	...
	public boolean detectMobile_sp() {
		...
		if (!isMobile_spExist) {
			...
			mProgress = BaseHelper.showProgress(mContext, null, "正在检查安全支付服务版本",
					false, true);
	...
	public void showInstallConfirmDialog(final Context context,
		...
		tDialog.setTitle(context.getResources().getString(
				R.string.xl_alipay_confirm_install_hint));
		tDialog.setMessage(context.getResources().getString(
				R.string.xl_alipay_confirm_install));

		tDialog.setPositiveButton(R.string.xl_alipay_Ensure,
		...
		tDialog.setNegativeButton(
				context.getResources().getString(R.string.xl_alipay_Cancel),
				new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int which) {
					}
				});
