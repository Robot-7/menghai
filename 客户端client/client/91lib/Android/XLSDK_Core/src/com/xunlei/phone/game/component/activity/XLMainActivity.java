...
public class XLMainActivity extends Activity {
		...
		public void handleMessage(Message msg) {
			...
			case Result.ACCOUNT_EXIST:
				if (autoGenAccount && (autoRegisterCount++ < retryRegisterTimes)) {
					...
					Toast.makeText(XLMainActivity.this, R.string.xl_account_exist_tip, Toast.LENGTH_SHORT).show();
				}
				break;
			case Result.VCODE_ERROR:
				Toast.makeText(XLMainActivity.this, R.string.xl_verify_code_input_error_tip, Toast.LENGTH_SHORT).show();
				break;
			case Result.CONNECT_ERROR:
				Toast.makeText(XLMainActivity.this, R.string.xl_connect_errror, Toast.LENGTH_SHORT).show();
				break;
			case Result.CUSTOMER_ID_NOT_GENERATE:
				init();
				onBackPressed();
				Toast.makeText(XLMainActivity.this, getString(R.string.xl_register_fail), Toast.LENGTH_SHORT).show();
				break;
			default:
				Toast.makeText(XLMainActivity.this, R.string.xl_operator_fail, Toast.LENGTH_SHORT).show();
			}
	...
	private Handler loginHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case Result.ACCOUNT_PASS_ERROR:
				Toast.makeText(XLMainActivity.this, R.string.xl_password_error_tip, Toast.LENGTH_SHORT).show();
				break;
			case Result.CONNECT_ERROR:
				Toast.makeText(XLMainActivity.this, R.string.xl_connect_errror, Toast.LENGTH_SHORT).show();
				break;
			case Result.CUSTOMER_ID_NOT_GENERATE:
				Toast.makeText(XLMainActivity.this, getString(R.string.xl_try_login_later), Toast.LENGTH_SHORT).show();
				break;
			default:
				Toast.makeText(XLMainActivity.this, R.string.xl_operator_fail, Toast.LENGTH_SHORT).show();
			}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.xl_activity_xlmain);

		callback = (ICallBack) this.getIntent().getSerializableExtra("callback");
		mProgressDialog = new ProgressDialog(this);
		mViewFlipper = (ViewFlipper) this.findViewById(R.id.xl_flipper_xlmain_login_main);

		LayoutInflater infla = LayoutInflater.from(this);
		mLoginActivity = infla.inflate(R.layout.xl_activity_login, mViewFlipper);
		mRegisterActivity = infla.inflate(R.layout.xl_activity_register, mViewFlipper);
	...
	private void init() {
		...
		mHeadLayout = this.findViewById(R.id.xl_head_layout);
		// mHeadLogo = (ImageView) this.findViewById(R.id.xl_head_logo);
	...
	private void bindLoginPage(View view) {
		mLoginUserNameText = (EditText) view.findViewById(R.id.xl_login_username_edittext);
		mLoginPasswordText = (EditText) view.findViewById(R.id.xl_login_password_edittext);

		TextView mLoginForgetPassword = (TextView) view.findViewById(R.id.xl_login_forget_password_textView);
		Button mRegisterButton = (Button) view.findViewById(R.id.xl_login_register_button);
		Button mLoginButton = (Button) view.findViewById(R.id.xl_login_login_button);
		mPopAccountsImageView = (ImageView) view.findViewById(R.id.xl_login_pop_accounts_imageView);

		mLoginRemberPassword = (CheckBox) view.findViewById(R.id.xl_login_remember_password_checkbox);
		final View area = this.findViewById(R.id.xl_login_area);
		...
		OnFocusChangeListener onFocusChangeListener = new OnFocusChangeListener() {
			...
			public void onFocusChange(View v, boolean hasFocus) {
				if (hasFocus) {
					area.setBackgroundResource(R.drawable.xl_blue_circle);
				} else {
					area.setBackgroundResource(R.drawable.xl_shape_window_bg);
				}
			}
		};
		...
		String text = getResources().getString(R.string.xl_forget_password);
		SpannableString sp = new SpannableString(text);
		NoUnderlineSpan urlSpan = new NoUnderlineSpan(getResources().getString(R.string.xl_forget_password_url));
		sp.setSpan(urlSpan, 0, text.length(), Spanned.SPAN_INCLUSIVE_EXCLUSIVE);
		sp.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.xl_login_forget_password)), 0, text.length(), Spannable.SPAN_EXCLUSIVE_INCLUSIVE);
		...
		mRegisterButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				hideSoftKeyBoard(v);
				Animation rInAnim = AnimationUtils.loadAnimation(XLMainActivity.this, R.anim.xl_push_right_in);
				Animation rOutAnim = AnimationUtils.loadAnimation(XLMainActivity.this, R.anim.xl_push_left_out);
		...
		mLoginButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (username.length() == 0) {
					Toast.makeText(XLMainActivity.this, R.string.xl_login_username_input_empty_tip, Toast.LENGTH_SHORT).show();
					return;
				}
				if (password.length() == 0) {
					Toast.makeText(XLMainActivity.this, R.string.xl_login_password_input_empty_tip, Toast.LENGTH_SHORT).show();
					return;
				}

				mProgressDialog.setMessage(getResources().getString(R.string.xl_login_loading));
	...
	private void bindInputPhonePopWindow(View view) {
		if (mPopupWindowInputPhone == null) {
			LayoutInflater infla = LayoutInflater.from(this);
			View popViewInputPhone = infla.inflate(R.layout.xl_activity_pop_input_phone, null);
			mPopupWindowInputPhone = new PopupWindow(popViewInputPhone,
					WindowManager.LayoutParams.MATCH_PARENT,
					WindowManager.LayoutParams.MATCH_PARENT, true);
			mPopupWindowInputPhone.setBackgroundDrawable(new
					ColorDrawable(-00000));// 有了这句才可以点击返回（撤销）按
			...
			mPopWindowInputPhoneText = (EditText) view.findViewById(R.id.xl_pop_input_phone_editText);
			Button mInputPhonePopWindowButton = (Button) view.findViewById(R.id.xl_pop_input_phone_next_button);
			mInputPhonePopWindowButton.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					register(mRegisterUserNameText.getText().toString().trim(),
							mRegisterPasswordText.getText().toString(),
							phoneNumber, registerHandler, manualInputPhoneFlag, false);
	...
	private void bindRegisterPage(View view) {
		final View area = this.findViewById(R.id.xl_register_area);
		TextView mRegisterUserProtocolTextView = (TextView) view.findViewById(R.id.xl_register_user_protocol_textView);
		mRegisterUserNameText = (EditText) view.findViewById(R.id.xl_register_username_edittext);
		mRegisterPasswordText = (EditText) view.findViewById(R.id.xl_register_password_edittext);

		mRegisterSendMessage = (CheckBox) view.findViewById(R.id.xl_register_send_message_checkbox);
		mRegisterAgree = (CheckBox) view.findViewById(R.id.xl_register_agree_protocol_checkbox);
		mRegisterClearUserName = (ImageView) view.findViewById(R.id.xl_register_clear_username);
		mRegisterClearPassword = (ImageView) view.findViewById(R.id.xl_register_clear_password);
		...
		String text = getResources().getString(R.string.xl_register_user_protocol);
		SpannableString sp = new SpannableString(text);
		NoUnderlineSpan urlSpan = new NoUnderlineSpan(getResources().getString(R.string.xl_register_user_protocol_url));
		sp.setSpan(urlSpan, 0, text.length(), Spanned.SPAN_INCLUSIVE_EXCLUSIVE);
		sp.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.xl_register_user_protocol)), 0, text.length(), Spannable.SPAN_EXCLUSIVE_INCLUSIVE);
		...
		Button mSubmitButton = (Button) view.findViewById(R.id.xl_register_register_button);
		mSubmitButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (!ValidatorUtil.isValidUserName(username)) {
					Toast.makeText(XLMainActivity.this, R.string.xl_register_username_input_error_tip, Toast.LENGTH_SHORT).show();
					return;
				}
				if (password.length() == 0) {
					Toast.makeText(XLMainActivity.this, R.string.xl_login_password_input_empty_tip, Toast.LENGTH_SHORT).show();
				...
				if (!ValidatorUtil.isValidPassword(password)) {
					Toast.makeText(XLMainActivity.this, R.string.xl_register_password_input_error_tip, Toast.LENGTH_SHORT).show();
					return;
				}

				if (!mRegisterAgree.isChecked()) {
					Toast.makeText(XLMainActivity.this, R.string.xl_register_disagree_protocol_tip, Toast.LENGTH_SHORT).show();
					return;
				}
				...
				if (ValidatorUtil.isPhone(phoneNumber)) {
					if (mRegisterSendMessage.isChecked()) {
						register(mRegisterUserNameText.getText().toString(),
								mRegisterPasswordText.getText().toString(),
								phoneNumber, registerHandler, manualInputPhoneFlag, false);
					}
					else {
					...
					if (mRegisterSendMessage.isChecked()) {
						...
						register(mRegisterUserNameText.getText().toString(),
								mRegisterPasswordText.getText().toString(),
								null, registerHandler, manualInputPhoneFlag, false);
					}
				}
	...
	private void popInputPhoneDialog(View v) {
		if (mInputPhoneDialog == null) {
			...
			View view = li.inflate(R.layout.xl_activity_pop_input_phone, null);
	...
	private void popAccountSelectingDialog(View v) {
		if (mPopupWindowAccountSelecting == null) {
			LayoutInflater infla = LayoutInflater.from(this);
			View popViewAccountSelecting = infla.inflate(R.layout.xl_activity_pop_accounts, null);
			...
			mPopupWindowAccountSelecting.setBackgroundDrawable(new ColorDrawable(-00000));// 有了这句才可以点击返回（撤销）按
			...
			mListView = (ListView) popViewAccountSelecting.findViewById(R.id.xl_login_accounts_list);
			if (data.size() >= 4) {
	...
	private void register(String username, String password, String phoneNo, Handler handler, boolean manualInputPhoneFlag, boolean retryRegisterFlag) {
		mProgressDialog.setMessage(getResources().getString(R.string.xl_register_loading));
		mProgressDialog.setCancelable(false);
		mProgressDialog.show();
	...
	public void onBackPressed() {
		if (current == 1) {
			Animation rInAnim = AnimationUtils.loadAnimation(this, R.anim.xl_push_left_in);
			Animation rOutAnim = AnimationUtils.loadAnimation(this, R.anim.xl_push_right_out);
	...
	class MyAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				convertView = layoutInflater.inflate(R.layout.xl_activity_pop_accounts_item, null);
				viewHolder = new ViewHolder();
				viewHolder.gougou = (ImageView) convertView.findViewById(R.id.xl_login_pop_gougou_imageView);
				viewHolder.account = (TextView) convertView.findViewById(R.id.xl_login_pop_account_textView);
