...
public class XLChargeYTKResult extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.xl_activity_charge_ykt_result);
        ...
        TextView orderText = (TextView) findViewById(R.id.xl_charge_ytk_order);
        orderText.setText(order);

        Button ok = (Button) findViewById(R.id.xl_charge_pay_button);
