 ...
 */
public class SkillSelecter {
    private List<Integer> id;
    private List<Integer> quality;
    private List<Integer> skillType;
    ...
    public SkillSelecter(){
        ...
        this.skillType = new ArrayList<Integer>();
    ...
    public void setSkillType(List<Integer> skillType) {
    ...
    public List<Integer> getSkillType() {
        return skillType;
    }
