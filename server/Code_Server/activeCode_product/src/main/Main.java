		...
		public void actionPerformed(ActionEvent e) {
			...
			if (e.getSource().equals(jb1)) 
			{
				try 
				{
					...
					String channel = (tf3.getText().replace(" ","").substring(0, 2));
					List<ActiveCodeEntity> cdkeys = CdkeyUtil.createCdkeysList(count, type, channel);
					ActiveCodeDao dao=new ActiveCodeDao();
					dao.saveList(cdkeys);
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (e.getSource().equals(jb2)) 
			{
				try 
				{
					...
					ActiveCodeDao dao=new ActiveCodeDao();
					List<ActiveCodeEntity> list=dao.queryWithCondition(condition);
					ExcelUtil.exportExcel(list, channel ,type);
